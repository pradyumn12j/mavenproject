    ...
    stage('Tag Docker Image') {
            steps {
                script {
                    ...
                    sh 'docker tag pradyumnjawale/test_maven:10.15 127214163347.dkr.ecr.ap-southeast-1.amazonaws.com/pradyumnjawale:10.15'}
            }
        }
    stage('docker push'){
      steps{
        sh 'docker push 127214163347.dkr.ecr.ap-southeast-1.amazonaws.com/pradyumnjawale:10.15'
      }
    }
  }
}
